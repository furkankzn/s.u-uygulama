...
import 'package:proje2/sayfalar/anket/soru9.dart';
...
class soru8 extends StatefulWidget {
  ...
  soru8({required this.AdSoyad,required this.cevap1,required this.cevap2,required this.cevap3,required this.cevap4,required this.cevap5,required this.cevap6,required this.cevap7}) ;
  @override
